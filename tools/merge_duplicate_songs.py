...
MERGES = [
    ...
    (
        "765as_私はアイドル_2", "765as_私はアイドル",
        "同じ曲の二重登録 (曲名がハート 1 文字違い: ♥ と ♡)。作詞作曲・配信 ID (1659368283) が"
        "同一で、消す側は GRE@TEST BEST! 収録分として別 id で起こされたもの。"
        "コロムビアの他の盤 (REM@STER-B / ファミソン 8BIT MIX) の DB 表記に揃えて ♡ 側を残す。"
        "残す側はセトリ 15 件、消す側はセトリ 1 件 (sh_L0987) とコミュニティのタグ/お気に入り/投票。",
    ),
]
